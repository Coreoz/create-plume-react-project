...
import { DeclaredRoutePaths } from '../../router/RouterDefinition';
...
export default class AdminTheme implements PlumeAdminTheme {
  ...
  actionLink: <T extends DeclaredRoutePaths> (props: ActionLinkProps<T>) => JSX.Element = ActionLink;
  ...
  panelTitle: <T extends DeclaredRoutePaths> (props: PanelTitleProps<T>) => JSX.Element = PanelTitle;
