...
import BrowserPageActivityManager
  from '../lib/user-session/page-activity/BrowserPageActivityManager';
import PageActivityManager from '../lib/user-session/page-activity/PageActivityManager';
import BrowserUserActivityListener
  from '../lib/user-session/user-activity/BrowserUserActivityListener';
